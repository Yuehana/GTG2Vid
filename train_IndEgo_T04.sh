...
CUDA_VISIBLE_DEVICES=0 python main.py --config /mnt/22TB_IndEgo/GTG2Vid/configs/IndEgo/IndEgo_vc_T05/vc_4omini_post_db0.4.json --dir best
...
#CUDA_VISIBLE_DEVICES=0 python main.py --config configs/EgoPER/coffee/vc_4omini_post_db0.3_ndb0.json --dir best