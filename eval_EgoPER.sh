#CUDA_VISIBLE_DEVICES=0 python main.py --config configs/EgoPER/tea/vc_4omini_post_db0.6.json --dir best --eval --vis
...
CUDA_VISIBLE_DEVICES=0 python main.py --config configs/EgoPER/coffee/vc_4omini_post_db0.3_ndb0.json --dir best_11_18_14_31_19  --eval --vis
